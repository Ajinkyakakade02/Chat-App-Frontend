  ...
  return (
    ...
    <Stack direction="row" alignItems='center' justifyContent='space-between'>
        ...
        {online ? <StyledBadge overlap='circular' anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
              variant="dot">
            <Avatar src={getAvatar(100)} alt={faker.name.fullName()} />
            </StyledBadge> : <Avatar src={getAvatar(101)} alt={faker.name.fullName()}/>}
...
const CallElement = ({online}) => {
  return (
    ...
    <Stack direction="row" alignItems='center' justifyContent='space-between'>
        ...
        {online ? <StyledBadge overlap='circular' anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
              variant="dot">
            <Avatar src={getAvatar(200)} alt={faker.name.fullName()} />
            </StyledBadge> : <Avatar src={getAvatar(201)} alt={faker.name.fullName()}/>}
